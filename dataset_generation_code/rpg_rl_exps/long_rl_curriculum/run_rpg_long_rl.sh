...
WORK_DIR="${WORK_DIR:-/work/ADS_shared/dataset_generation_code/rpg_rl_exps/long_rl_curriculum}"
export XDG_CACHE_HOME="${XDG_CACHE_HOME:-/tmp/long_rl_curriculum_cache}"
export WANDB_DIR="${WANDB_DIR:-$WORK_DIR/wandb}"
export WANDB_DATA_DIR="${WANDB_DATA_DIR:-$WORK_DIR/wandb-data}"
export WANDB_CACHE_DIR="${WANDB_CACHE_DIR:-/tmp/long_rl_curriculum_wandb_cache}"
export TRITON_CACHE_DIR="${TRITON_CACHE_DIR:-/tmp/long_rl_curriculum_triton_cache}"
export TILELANG_CACHE_DIR="${TILELANG_CACHE_DIR:-/tmp/long_rl_curriculum_tilelang_cache}"
export FLASHINFER_WORKSPACE_BASE="${FLASHINFER_WORKSPACE_BASE:-/tmp/long_rl_curriculum_flashinfer}"
export UV_CACHE_DIR="${UV_CACHE_DIR:-/tmp/long_rl_curriculum_project_uv_cache}"
...
uv run --isolated --extra fsdp -m long_rl_curriculum.main_rpg_long \
