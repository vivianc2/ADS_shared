...
| qwen3-small | 20 | 1 | 0.05 [0.01, 0.24] | 0.35 | 0.46 | 9 |

## By topology (accept rate [95% CI], n)

| Topology | opus4.8 | qwen3-small |
|---|---|---|
| bioreactor_titer_loss | 4/5 (0.80) [0.38,0.96] | 1/5 (0.20) [0.04,0.62] |
...
| Topology | n | Accept | Part-A rate | Mean Part-B |
|---|---|---|---|---|
| bioreactor_titer_loss | 5 | 1/5 | 0.60 | 0.80 |
| datacenter_throughput | 5 | 0/5 | 0.00 | 0.32 |
| greenhouse_yield | 5 | 0/5 | 0.20 | 0.30 |
| clinic_readmission | 5 | 0/5 | 0.60 | 0.43 |
